...
import { Anyo } from '../../models/Anyo/anyo'
...
fullA(){//es para ver el grafo completo de todos los anios (grupal)
  this.fase2service.getImagenAnyo().subscribe((dataList: any) => {
    this.imgBack = dataList
    //this.  ListaDeTiendasInventario2 =dataList
    //console.log("kkkkkkkkkkkkkkkkkkk\n" + this.imgBack)
    //---------------------------------------------
      this.imageBase64 = this.imgBack
...
Anyo(cadena){//es para ver el grafo seleccionado de anios (individual)
  console.log(">>>>>soy el anyo:"+cadena.Anio+"\n")
  //POST PARA Q RETORNE ARREGLO DE ANYO
  var str ="{\"Anio\":\""+cadena.Anio+"\"}"
  this.fase2service.getImagenAnyoUnica(str).subscribe((dataList: any) => {
    this.imgBack = dataList
    //this.  ListaDeTiendasInventario2 =dataList
    //console.log("kkkkkkkkkkkkkkkkkkk\n" + this.imgBack)
    //---------------------------------------------
...
agregar(nombre){
  ...
  nombre.focus()//para q siga el cursor en el input del html
  console.log(nombre.value)//.value me devuelve el string q quiero sin esto me devuelve el comonente
  this.fila = nombre.value
  //nombre.value=""//limpiio el input osea componente del html
  return false//hago q el form/input buttom no se actualize
}
...
agregar2(nombre){
  ...
  nombre.focus()//para q siga el cursor en el input del html
  console.log(nombre.value)//.value me devuelve el string q quiero sin esto me devuelve el comonente
  this.columna =nombre.value
  //nombre.value=""//limpiio el input osea componente del html
  return false//hago q el form/input buttom no se actualize
}

ObtenerCola(nombre,nombre2){
  this.fila = nombre.value
  this.columna =nombre2.value

console.log("fila:"+this.fila+" col:"+this.columna+" mes:"+this.mesCola+" anyo:"+this.anyoCola)
//HACER EL POST DE LAS COLAS
  //POST PARA Q RETORNE LA cola
  var str ="{\"Anio\":\""+this.anyoCola+"\",\"Mes\":\""+this.mesCola+"\",\"Fila\":\""+this.fila+"\",\"Col\":\""+this.columna+"\"}"
  this.fase2service.getCola(str).subscribe((dataList: any) => {//metodo para retornar la imagen de la matriz
    this.imgBack = dataList
    //this.  ListaDeTiendasInventario2 =dataList
    //console.log("kkkkkkkkkkkkkkkkkkk\n" + this.imgBack)
    //---------------------------------------------
...
//crear el post para q reciba fila,columna,

mesCola=""
anyoCola=""
Month(cadena,cadena2){//para ver la matriz dispersa
  console.log(">>>>>soy el mes:"+cadena.NombreMes+" /del anyo:"+cadena2.Anio+"\n")

  this.mesCola=cadena.Mes
  this.anyoCola=cadena2.Anio

  //POST PARA Q RETORNE LA MATRIZ DISPERSA
  var str ="{\"Anio\":\""+cadena2.Anio+"\",\"Mes\":\""+cadena.Mes+"\"}"
  this.fase2service.getImagen(str).subscribe((dataList: any) => {//metodo para retornar la imagen de la matriz
    this.imgBack = dataList
    //this.  ListaDeTiendasInventario2 =dataList
    //console.log("kkkkkkkkkkkkkkkkkkk\n" + this.imgBack)
    //---------------------------------------------
  ...
  ngOnInit() {
    this.fase2service.getListaReportes().subscribe((dataList: any) => {
      this.ListaDeAnyos = dataList
      //this.  ListaDeTiendasInventario2 =dataList
      console.log("LISTA DE ANYOS\n" + this.ListaDeAnyos)
      //---------------------------------------------
      this.ListaDeAnyos.forEach(element => {
        console.log("anyo:"+element.Anio+"\n")
        element.Meses.forEach(element2 => {
          console.log("-"+element2.NombreMes+"\n")
  ...
  arboles(){
   ...
   this.fase2service.getListaInventario().subscribe((dataList: any) => {
    ...
    this.ListaDeTiendasInventario.forEach(element => {
      ...
      console.log("LLL:"+element.Calificacion+"|"+element.Nombre)
...
//crear el post y enviar lo q necesite para retornar la imagen del arbol al front-end




  //POST PARA Q RETORNE LA MATRIZ DISPERSA
  var valeria = "{ \"Calificacion\":"+tienda.Calificacion+",\"Fila\":\""+tienda.Nombre[0]+"\",\"Columna\":\""+tienda.Departamento+"\",\"NombreTienda\":\""+tienda.Nombre+"\" }"

  this.fase2service.getImagenArbol(valeria).subscribe((dataList: any) => {//metodo para retornar la imagen de la matriz
    this.imgBack = dataList
    //this.  ListaDeTiendasInventario2 =dataList
    //console.log("kkkkkkkkkkkkkkkkkkk\n" + this.imgBack)
    //---------------------------------------------
   ...
   }//fin de metodo q retorna el arbol de la tienda seleccionada
}
